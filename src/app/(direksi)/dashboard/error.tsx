...
export default function DireksiError({
  error,
  reset,
}: {
    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-md p-6 rounded-2xl bg-card border border-border text-center shadow-xl space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-foreground">Terjadi Kesalahan di Dashboard ⚠️</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Pimpinan yang terhormat, sistem mengalami kendala teknis saat memuat data dashboard.
          </p>
          {error.message && (
